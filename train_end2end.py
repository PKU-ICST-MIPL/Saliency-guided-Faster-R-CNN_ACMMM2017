...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch,
    ...
    if args.resume:
        ...
        #arg_params['label0'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['label0'])
        #arg_params['bbox_target0'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['bbox_target0'])
        #arg_params['bbox_weight0'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['bbox_weight0'])
        #arg_params['rpn_conv_3x30_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['rpn_conv_3x30_weight'])
        #arg_params['rpn_conv_3x30_bias'] = mx.nd.zeros(shape=arg_shape_dict['rpn_conv_3x30_bias'])
        #arg_params['rpn_cls_score0_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['rpn_cls_score0_weight'])
        #arg_params['rpn_cls_score0_bias'] = mx.nd.zeros(shape=arg_shape_dict['rpn_cls_score0_bias'])
        #arg_params['rpn_bbox_pred0_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['rpn_bbox_pred0_weight'])
        #arg_params['rpn_bbox_pred0_bias'] = mx.nd.zeros(shape=arg_shape_dict['rpn_bbox_pred0_bias'])
        #arg_params['cls_score0_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['cls_score0_weight'])
        #arg_params['cls_score0_bias'] = mx.nd.zeros(shape=arg_shape_dict['cls_score0_bias'])
        #arg_params['bbox_pred0_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['bbox_pred0_weight'])
        #arg_params['bbox_pred0_bias'] = mx.nd.zeros(shape=arg_shape_dict['bbox_pred0_bias'])
        ...
        arg_params['pool5_conv_1x1_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['pool5_conv_1x1_weight'])
        arg_params['pool5_conv_1x1_bias'] = mx.nd.zeros(shape=arg_shape_dict['pool5_conv_1x1_bias'])
        #arg_params['fc60_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['fc60_weight'])
        #arg_params['fc60_bias'] = mx.nd.zeros(shape=arg_shape_dict['fc60_bias'])
        #arg_params['fc70_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fc70_weight'])
        #arg_params['fc70_bias'] = mx.nd.zeros(shape=arg_shape_dict['fc70_bias'])
